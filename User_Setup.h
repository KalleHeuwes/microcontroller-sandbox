...
#define GC9A01_DRIVER     // Enable GC9A01 driver

// ESP8266 pins
#define TFT_MISO -1       // Not connected (no MISO on GC9A01)
...
// Optional: Adjust SPI frequency
#define SPI_FREQUENCY  40000000  // Max: 40 MHz
